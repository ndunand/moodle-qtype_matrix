...
class restore_qtype_matrix_plugin_test extends advanced_testcase {
    ...
    public function test_recode_response():void {
        ...
        $this->assertEquals($expectedrecoded, $mockedrestore->recode_response(
            $uselessnrbymock, $uselessnr, $multipleresponse
        ));
        ...
        $this->assertEquals($expectedrecoded, $mockedrestore->recode_response(
            $uselessnrbymock, $uselessnr, $singleresponse
        ));
        $badresponse = [
        ...
        $mockedrestore->recode_response(
            $uselessnrbymock, $uselessnr, $badresponse
        );
    }
